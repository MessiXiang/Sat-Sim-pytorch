...
class SimpleBattery(SimulationModule):
    ...
    def simulation_step(self, dt: Tensor, *args, **kwargs) -> Tensor:
        ...
        self.fault_capacity_ratio = kwargs.get("fault_ratio", torch.tensor(1.0))
...
if __name__ == "__main__":
    ...
    # 运行所有测试
    print("开始SimpleBattery单元测试...")
    print("=" * 50)

    try:
        test_battery_initialization()
        test_basic_charging()
        test_basic_discharging()
        test_capacity_limits()
        test_fault_conditions()
        ...
        print("\n" + "=" * 50)
        print("所有测试通过！SimpleBattery工作正常。")
